...
(library Library_1
	...
	(patternDef "SON127P600X500X80-9N-D" (originalName "SON127P600X500X80-9N-D")
		(multiLayer
	...
	(compDef "SST26VF064B-104I_MF" (originalName "SST26VF064B-104I_MF") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "WP#/SIO2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "HOLD/SIO3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "SCK") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "SI/SIO0") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SST26VF064B-104I_MF"))
		(attachedPattern (patternNum 1) (patternName "SON127P600X500X80-9N-D")
			(numPads 9)
			(padPinMap
		...
		(attr "Datasheet Link" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en561262")
		(attr "Height" "0.8 mm")
	)
